...
\begin{figure}[H]
 ...
 \captionof{figure}{A theoretical example of what one sided cosmic $\mu$ tomography looks like. The more material that cosmic $\mu$ have to pass through the lower chance they will be detected by the detector via attenuation.} 
